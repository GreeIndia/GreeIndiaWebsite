                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                                    {groupedProducts[segment].map((product, pIdx) => (
                                        <motion.div 
                                            ...
                                            key={product._id} 
                                            className="bg-white rounded-[2rem] overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgba(29,78,216,0.1)] transition-all duration-500 hover:-translate-y-2 border border-gray-100 group flex flex-col relative"
                                        >
                                            {/* Image placeholder */}
                                            <Link to={`/product/${product._id}`} className="bg-gradient-to-b from-gray-50 to-white h-64 flex justify-center items-center relative overflow-hidden cursor-pointer block">
                                            ...
                                            <div className="p-7 lg:p-8 flex-grow flex flex-col bg-white">
                                                <div className="flex justify-between items-start mb-3">
                                                    <Link to={`/product/${product._id}`}>
                                                        <h3 className="text-2xl font-black text-gray-900 group-hover:text-blue-700 transition-colors cursor-pointer tracking-tight">
