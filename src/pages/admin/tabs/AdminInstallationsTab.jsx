...
const AdminInstallationsTab = ({ installations, loading, setSupportModal, handleSupportStatusUpdate, handleSupportDelete }) => {
    return (
            ...
            <div className="w-full overflow-x-auto">
                <table className="w-full min-w-[1000px] lg:min-w-full text-left border-collapse">
                    ...
                    <tbody>
                        {loading ? (
                            <tr>
                                <td colSpan="6" className="p-10 text-center text-sm font-bold text-gray-400">Loading installation requests...</td>
                            </tr>
                        ) : installations.length === 0 ? (
                            <tr>
                                <td colSpan="6" className="p-10 text-center text-sm font-bold text-gray-400">No active installation requests.</td>
                            </tr>
